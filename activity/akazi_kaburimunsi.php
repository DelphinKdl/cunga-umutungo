...
$get_akazi_kose = mysql_query("SELECT * FROM akazi_kaburimunsi WHERE  employee_id=".$_SESSION['employee_id']."");
$total_records = mysql_num_rows($get_akazi_kose);
$get_akazi = mysql_query("SELECT * FROM akazi_kaburimunsi WHERE  employee_id=".$_SESSION['employee_id']." ORDER BY akazi_id DESC LIMIT $start, " . $_SESSION['records_per_page'] . "");

if(isset($_GET['query'])) {
$query = mysql_real_escape_string($_GET['query']);
$get_akazi = mysql_query("SELECT * FROM akazi_kaburimunsi WHERE (tariki_yakazi LIKE '%$query%') OR (umunsiwakazi LIKE '%$query%') AND employee_id=".$_SESSION['employee_id']."");
$total_records = mysql_num_rows($get_akazi);
